...
```{r}
#Wrangling data to create a data frame that shows that keeps size measurements from the year 2013 and 2018. 
...
ggplot(data = lobster_size_b, aes(x = site, y = size_mm))+
  ...
  labs(x = "Year",
      y = "Size (mm)",
      title = "Lobster size distribution shifts Santa Barbara LTER")+
  xlab("year")+
  ylab("size_avg")+
  facet_wrap(~ year)+
  theme_classic()
